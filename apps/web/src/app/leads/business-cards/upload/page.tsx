...
export default function LeadBusinessCardUploadPage() {
  ...
  const uploadMutation = trpc.leadBusinessCard.upload.useMutation();
        ...
        prev.map((img, index) => {
          ...
          if (uploadResult && 'success' in uploadResult && uploadResult.success) {
            return {
              ...
              leadId: (uploadResult as any).lead?.id,
            };
          } else {
            return {
              ...img,
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">
            Upload Business Cards (Leads)
          </h1>
          <p className="text-gray-600 mt-2">
            Snap photos of multiple business cards to build your leads database
          </p>
        </div>
